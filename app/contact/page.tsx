...
function Row({ k, v }: { k: string; v: string }) {
  return (
    ...
    >
      <span className="mono" style={{ fontSize: 11, color: "var(--ink-3)", letterSpacing: "0.10em", alignSelf: "center" }}>
        {k.toUpperCase()}
      </span>
  ...
  return (
    <label className={error ? "field-error" : ""} style={{ display: "block" }}>
      ...
      >
        ...
        {error && (
          <span style={{ color: "var(--red)", textTransform: "none", letterSpacing: "normal" }}>{error}</span>
        )}
      </div>
      {children}
    </label>
  ...
  if (confirmation) {
    return (
      <div
        ...
        style={{ minHeight: "70vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px 32px" }}
      >
        <div style={{ maxWidth: 600, textAlign: "center" }}>
          ...
          <div
            className="mono"
            style={{ fontSize: 11, letterSpacing: "0.20em", color: "var(--ink-3)", marginBottom: 14 }}
          >
            BOOKING #{confirmation.bookingId}
          </div>
          <h1
            className="display"
            style={{ fontSize: "clamp(40px, 6vw, 72px)", fontWeight: 800, margin: "0 0 16px", lineHeight: 0.95 }}
          >
            Got it, {confirmation.name.split(" ")[0]}.
            <br />
            Tasha will call you back
            <br />
            in under 10 minutes.
          </h1>
          <p style={{ color: "var(--ink-2)", fontSize: 17, lineHeight: 1.55, marginBottom: 32 }}>
            We&apos;ll confirm the appointment, give you an arrival window, and tell you which technician is rolling
            out.
          </p>
          <div
            style={{
          ...
          >
            <div className="mono" style={{ fontSize: 11, color: "var(--ink-3)", letterSpacing: "0.14em" }}>NAME</div>
            <div style={{ fontWeight: 600 }}>{confirmation.name}</div>
            <div className="mono" style={{ fontSize: 11, color: "var(--ink-3)", letterSpacing: "0.14em" }}>PHONE</div>
            <div style={{ fontWeight: 600 }}>{confirmation.phone}</div>
            <div className="mono" style={{ fontSize: 11, color: "var(--ink-3)", letterSpacing: "0.14em" }}>SERVICE</div>
            <div style={{ fontWeight: 600 }}>{confirmation.service}</div>
            <div className="mono" style={{ fontSize: 11, color: "var(--ink-3)", letterSpacing: "0.14em" }}>ADDRESS</div>
            <div style={{ fontWeight: 600 }}>{confirmation.address}</div>
            <div className="mono" style={{ fontSize: 11, color: "var(--ink-3)", letterSpacing: "0.14em" }}>URGENCY</div>
            <div style={{ fontWeight: 600, textTransform: "capitalize" }}>{confirmation.urgency}</div>
          </div>
          <button
    ...
    <div className="page-enter">
      <section style={{ borderBottom: "1.5px solid var(--ink)" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "72px 32px 32px" }}>
          ...
          <h1
            className="display"
            style={{ fontSize: "clamp(60px, 9vw, 144px)", fontWeight: 900, margin: "0 0 20px", lineHeight: 0.9 }}
          >
            Tell us what&apos;s
            <br />
            wrong with the door.
          </h1>
          <p style={{ fontSize: 20, color: "var(--ink-2)", maxWidth: 600, lineHeight: 1.5, margin: 0 }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "56px 32px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 48 }}>
            ...
            <form
              ...
              style={{ background: "var(--paper)", border: "1.5px solid var(--ink)", padding: "40px 40px 36px" }}
            >
              <div className="mono" style={{ fontSize: 11, letterSpacing: "0.20em", color: "var(--ink-3)", marginBottom: 8 }}>
                § BOOKING FORM
              </div>
              <h2 className="display" style={{ fontSize: 36, fontWeight: 800, margin: "0 0 28px" }}>
              ...
              <div style={{ marginTop: 24 }}>
                <div className="mono" style={{ fontSize: 11, letterSpacing: "0.14em", color: "var(--ink-3)", marginBottom: 10 }}>
                  HOW URGENT?
                </div>
                <div
                  style={{
                ...
                >
                  {[
                    ...
                    <button
                      ...
                      onClick={() => {
                        setUrgency(o.v);
                        setValue("urgency", o.v);
                      }}
                      style={{
                        padding: "14px 16px",
                        textAlign: "left",
                        background: urgency === o.v ? "var(--ink)" : "var(--paper)",
                        color: urgency === o.v ? "var(--paper)" : "var(--ink)",
                        border: "none",
              ...
              <div style={{ marginTop: 18 }}>
                <Field label="Anything else? (optional)" error={errors.message?.message}>
                  <textarea
                    {...register("message")}
                    rows={4}
                    placeholder="Brand of opener, age of door, weird noises, what you've already tried…"
                  />
                </Field>
              </div>
            ...
            <aside style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div style={{ background: "var(--ink)", color: "var(--paper)", padding: "28px 28px" }}>
                <div
                  className="mono"
                  style={{ fontSize: 11, letterSpacing: "0.20em", color: "var(--amber)", marginBottom: 6 }}
                >
                  EMERGENCY LINE
                </div>
                <a
                ...
                <div style={{ marginTop: 14, fontSize: 13, color: "var(--paper-3)" }}>
                  Live human, 24/7. We won&apos;t put you on hold.
                </div>
              </div>
              ...
              <InfoBlock icon={<IconPin />} title="Service area">
                <p style={{ margin: 0, fontSize: 14, color: "var(--ink-2)", lineHeight: 1.55 }}>
                  Raleigh · Cary · Durham · Chapel Hill · Apex · Morrisville · Wake Forest · Garner · Holly Springs ·
                  Knightdale
                </p>
                <div
                  className="mono"
                  style={{ marginTop: 12, fontSize: 11, color: "var(--ink-3)", letterSpacing: "0.10em" }}
                >
      ...
      <section>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "56px 32px 80px" }}>
          ...
          <h2 className="display" style={{ fontSize: "clamp(36px, 4vw, 56px)", fontWeight: 800, margin: "0 0 32px" }}>
